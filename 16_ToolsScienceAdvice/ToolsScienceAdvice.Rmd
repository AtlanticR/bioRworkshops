...
```{r, echo=F}
knitr::include_graphics("Y:/Projects/ShinyCourse/agenda.png")
```
...
eval <- read.csv("Y:/Projects/ShinyCourse/Interactive Tools For Science Advice - Workshop Evaluation .csv")
